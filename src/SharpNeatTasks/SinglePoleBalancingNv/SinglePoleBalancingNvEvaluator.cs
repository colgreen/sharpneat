...
{
    /// <summary>
    /// Evaluator for the Single Pole Balancing task variant with no velocity inputs.
    /// </summary>
    public class SinglePoleBalancingNvEvaluator : IPhenomeEvaluator<IBlackBox<double>>
    {
        ...
        /// </summary>
		public SinglePoleBalancingNvEvaluator() 
        ...
        public FitnessInfo Evaluate(IBlackBox<double> box)
        {
			...
			for(; timestep < _maxTimesteps; timestep++)
			{
                ...
                box.InputVector[2] = physics.PoleAngle / TwelveDegrees;         // pole_angle is +-twelve_degrees; here we normalize it to [-1,1].
