...
namespace SharpNeat.Tasks.SinglePoleBalancingNv
{
    ...
    /// variant with no velocity inputs.
    /// </summary>
    public class SinglePoleBalancingNvExperimentFactory : INeatExperimentFactory<double>
    {
        ...
        public INeatExperiment<double> CreateExperiment(string jsonConfig)
        {
            ...
            var evalScheme = new SinglePoleBalancingNvEvaluationScheme();

            // Create a NeatExperiment object with the evaluation scheme.
            var experiment = NeatExperiment<double>.CreateAcyclic(
                "Single Pole Balancing (no velocity inputs)",
                evalScheme,
