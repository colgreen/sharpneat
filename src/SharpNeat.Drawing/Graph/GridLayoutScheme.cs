...
{
    /// <summary>
    /// An <see cref="ILayoutScheme"/> that positions nodes evenly spaced out into a grid arrangement.
    /// </summary>
    public class GridLayoutScheme : ILayoutScheme
    {
        const int MarginX = 0;
        ...
        public void Layout(IOGraph graph, Size layoutArea)
        {
            ...
            {   
                ...
                // Must be at least one layer if we have nodes.
