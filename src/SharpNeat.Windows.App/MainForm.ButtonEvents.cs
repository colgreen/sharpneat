...
partial class MainForm
{
    ...
    {
        _neatExperiment = CreateAndConfigureExperiment<float>(
    ...
    private void btnSearchStart_Click(object sender, EventArgs e)
    {
        ...
        NeatEvolutionAlgorithm<float> ea = NeatEvolutionAlgorithmFactory.CreateEvolutionAlgorithm(neatExperiment, _neatPop);
        ea.Initialise();
