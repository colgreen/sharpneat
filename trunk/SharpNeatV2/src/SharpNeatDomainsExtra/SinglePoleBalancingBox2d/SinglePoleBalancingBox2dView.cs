...
namespace SharpNeat.DomainsExtra.SinglePoleBalancingBox2d
{
    ...
    public class SinglePoleBalancingBox2dView : Box2dDomainView
    {
        ...
        /// </summary>
        protected override bool TestStopCondition()
        {
            // Never stop. This allows the user to interact with the box2D world for as long as they wish.
            return false;

            // Here's the stop condition used by the evaluation code.
            //SinglePoleBalancingWorld simWorld = (SinglePoleBalancingWorld)_simWorld;
            //        return (simWorld.CartPosX < -__TrackLengthHalf) || (simWorld.CartPosX > __TrackLengthHalf)
